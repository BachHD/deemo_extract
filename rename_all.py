...
res_file_list = glob.glob(os.path.join(source_dir, "*"))
for res_file in res_file_list:
    if ("sharedasset" in res_file or ".resource" in res_file):
        continue

    #Get real name
    real_name = get_real_name(res_file)
